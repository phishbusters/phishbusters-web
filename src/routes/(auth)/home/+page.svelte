<svelte:head>
	<title>Salvia-kit Dashboard v6 with Svelte-kit</title>
</svelte:head>
...
<div class="flex flex-col flex-wrap sm:flex-row">
	<div class="w-full md:w-4/12 pr-2 mb-6">
		<div class="shadow rounded-2xl p-4 bg-white">
			<div class="flex items-center">
				...
				<p class="text-md text-black ml-2">Total Gains</p>
			</div>
	...
	<div class="w-full md:w-4/12 pr-2 mb-6">
		<div class="shadow rounded-2xl p-4 bg-white">
			<div class="flex items-center">
				...
				<p class="text-md text-black ml-2">Outgoings</p>
			</div>
			<div class="flex flex-col justify-start">
				<p class="text-gray-700 text-4xl text-left font-bold my-4">
					10,000
	...
	<div
		class="shadow-lg rounded-xl w-full md:w-3/12 p-4 md:mr-2 bg-white relative overflow-hidden mt-8"
	>
		<p class="text-gray-600 text-xl font-medium mb-6">Popular Investissors</p>
		<div class="grid grid-cols-3 gap-4">
			<div class="flex flex-col items-center">
				...
				<span class="text-gray-600 text-xs mt-2"> Enoch Ndika </span>
			</div>
			<div class="flex flex-col items-center">
				<div class="relative">
					<span class="block relative">
				...
				<span class="text-gray-600 text-xs mt-2"> Lionel Messi </span>
			</div>
			<div class="flex flex-col items-center">
				<div class="relative">
					<span class="block relative">
				...
				<span class="text-gray-600 text-xs mt-2"> Jonathan Ilunga </span>
			</div>
			<div class="flex flex-col items-center">
				<div class="relative">
					<span class="block relative">
				...
				<span class="text-gray-600 text-xs mt-2"> Maurice Lokumba </span>
			</div>
			<div class="flex flex-col items-center">
				<div class="relative">
					<span class="block relative">
				...
				<span class="text-gray-600 text-xs mt-2"> Cristiano Ronaldo </span>
			</div>
			<div class="flex flex-col items-center">
				<div class="relative">
					<span class="block relative">
				...
				<span class="text-gray-600 text-xs mt-2"> Dave Glad </span>
			</div>
		</div>
	</div>
	<div
		class="shadow-lg rounded-xl w-full md:w-4/12 mt-8 md:ml-2 p-4 bg-white text-gray-700 relative overflow-hidden"
	>
		<span class="w-full h-full block">
			<div class="w-full">
				<p class="text-gray-700 text-2xl font-light mb-4">Task Progress</p>
	...
	<div
		class="shadow-lg rounded-xl w-full md:w-4/12 md:ml-4 mt-8 p-4 bg-white relative overflow-hidden"
	>
		<div class="w-full flex items-center justify-between mb-8">
			<p class="text-gray-800 text-xl">Account</p>
			<span
				class="flex items-center text-sm hover:text-gray-600 text-gray-300 border-0 focus:outline-none"
			>
				VIEW ALL
			</span>
		</div>
